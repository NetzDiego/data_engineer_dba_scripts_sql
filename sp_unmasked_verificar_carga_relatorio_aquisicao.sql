/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  Diego Silva                        2025-09-01                                                          verificar a carga do dia referente unmasked_relatorio_aquisicao
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/

CREATE OR REPLACE PROCEDURE vortx.sp_unmasked_verificar_carga_relatorio_aquisicao(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE
...
END;
$BODY$;
ALTER PROCEDURE vortx.sp_unmasked_verificar_carga_relatorio_aquisicao()
    OWNER TO netz_admin;
